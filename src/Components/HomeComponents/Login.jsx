...
const Login = () => {
    ...
    return (
        <div className="mt-3 p-5">
            ...
            <div className="container mx-auto  w-full max-w-md p-8 space-y-3 rounded-xl bg-[#cfe8fc] ">
                ...
                <form
                    ...
                    <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 bg-sky-400">Log In</button>
                </form>
