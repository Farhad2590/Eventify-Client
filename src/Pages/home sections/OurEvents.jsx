import concert from '../../assets/concerts.jfif'
import birthday from '../../assets/birthday.jfif'
import conference from '../../assets/conference.jfif';
import wedding from '../../assets/wedding.jpg'
import festival from '../../assets/festivals.jfif'
        ...
        <div className='container mx-auto'>
            ...
            <div>
                <div className=" rounded-md shadow-md">
                    ...
                    <div className="bg-[#3A86FF] p-2 rounded-b">
                        <div>
